...
Complete API reference for Valiant Picks backend.

**Base URL (Development):** `http://localhost:5000/api`  
**Base URL (Production):** `https://valiantpicks.com/api`
...
```json
{
  "games": [
    {
      "id": 1,
      "home_team": "Valiant Varsity",
      "away_team": "Rival High",
...
```json
{
  "teams": [
    {
      "id": 1,
      "name": "Valiant Varsity Basketball",
      "type": "varsity",
      "record_wins": 12,
      "record_losses": 3,
      "league_record": "8-2",
...
```json
{
  "propBets": [
    {
      "id": 1,
      "title": "Will Valiant win by 10+ points?",
      "description": "Bet YES if Valiant wins by 10 or more points",
      "team_type": "varsity",
      "yes_odds": 1.8,
      "no_odds": 2.2,
...
```json
{
  "title": "Will Valiant score 80+ points?",
  "description": "Bet YES if Valiant scores 80 or more points",
  "team_type": "varsity",
  "yes_odds": 1.6,
  "no_odds": 2.4,
  "expires_at": "2026-01-20T19:00:00Z"
  ...
  "transactions": [
    {
      ...
      "type": "bet",
      "amount": -100,
      "description": "Bet placed on Valiant vs Rival",
      "status": "completed",
      "created_at": "2026-01-15T14:30:00Z"
    },
    {
      ...
      "type": "win",
      "amount": 150,
      "description": "Won bet on Valiant vs Opponent",
      "status": "completed",
  ...
  "notifications": [
    {
      ...
      "message": "Congratulations! Your bet on Valiant won. +$150",
      "is_read": false,
      "created_at": "2026-01-14T20:00:00Z"
    }
  ]
...
**Questions?** Open an issue on [GitHub](https://github.com/yourusername/valiant-picks/issues)
