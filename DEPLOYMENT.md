...
Complete guide to deploying Valiant Picks to production.
...
5. Select your `valiant-picks` repository
...
3. Go to **Settings**:
   - **Service Name**: valiant-picks-api
...
4. Once deployed, copy your Railway URL:
   ```
   https://valiant-picks-api.railway.app
   ```
...
const apiClient = axios.create({
  baseURL: process.env.REACT_APP_API_URL || 'https://valiant-picks-api.railway.app/api',
...
```env
REACT_APP_API_URL=https://valiant-picks-api.railway.app/api
```
...
3. Connect to GitHub
4. Select your `valiant-picks` repository
5. Configure build:
   - **Project name**: valiant-picks
...
3. You'll get a URL like: `https://valiant-picks.pages.dev`
...
3. Enter your domain: `valiantpicks.com`
...
To use custom domain for API (e.g., `api.valiantpicks.com`):

1. In Railway project → **Settings** → **Domains**
2. Add custom domain
3. Add CNAME record in Cloudflare DNS:
   ```
   api.valiantpicks.com -> your-project.railway.app
   ```
4. Update frontend API URL to `https://api.valiantpicks.com`
...
Deploy:
```bash
heroku create valiant-picks-api
...
**Congratulations!** 🎉 Your Valiant Picks platform is now live!
