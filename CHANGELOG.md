...
All notable changes to Valiant Picks will be documented in this file.
...
The first production-ready release of Valiant Picks!
...
- Clean, modern design with Valiant branding
...
### Added
- Beta testing with Valiant Academy students
...
- **v1.0.0** (2026-01-14) - Production release
- **v0.9.0** (2026-01-10) - Beta testing phase
- **v0.8.0** (2026-01-05) - Alpha release
- **v0.1.0** (2025-12-20) - Initial development
...
- **Beta Testers** - Valiant Academy students and faculty
- **Contributors** - See [GitHub Contributors](https://github.com/yourusername/valiant-picks/graphs/contributors)
...
- Open an [issue](https://github.com/yourusername/valiant-picks/issues)
- Check the [discussions](https://github.com/yourusername/valiant-picks/discussions)
- Email: your-email@example.com

---

[Unreleased]: https://github.com/yourusername/valiant-picks/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/yourusername/valiant-picks/releases/tag/v1.0.0
[0.9.0]: https://github.com/yourusername/valiant-picks/releases/tag/v0.9.0
[0.8.0]: https://github.com/yourusername/valiant-picks/releases/tag/v0.8.0
